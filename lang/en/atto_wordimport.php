...
$string['dynamicstyles'] = 'Front-end web framework';
$string['dynamicstyles_desc'] = 'Default HTML/CSS framework to apply in conversion process';
$string['dynamicstyles_bootstrap'] = 'Bootstrap 4 (Moodle)';
$string['dynamicstyles_daylight'] = 'Daylight (Brightspace)';
$string['dynamicstyles_none'] = 'None';
